...
namespace xtd{
    ...
    private:
        ...
        static_assert(wordbits & (wordbits-1) == 0,
                      "Not a power of two number of bits in a word!");
    public:
        ...
        constexpr fast_size_t size() const {
            return size_;
        }
        
        constexpr fast_size_t size_bytes() const {
            return (size_ + wordbits - 1) / wordbits;
        }
